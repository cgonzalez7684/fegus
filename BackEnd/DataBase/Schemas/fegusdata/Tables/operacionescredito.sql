...
(
    ...
    "IndicadorOperacionModificada" character varying(1) COLLATE pg_catalog."default" NOT NULL,
    "IndicadorPresentaCodeudores" character varying(1) COLLATE pg_catalog."default" NOT NULL,
    "TipoEnfoque" numeric(2,0) NOT NULL,
    "TipoSegmento" numeric(2,0) NOT NULL,
    "CodigoEtapa" numeric(2,0) NOT NULL,
    "CodigoCategoriaRiesgo" numeric(2,0) NOT NULL,
    ...
    "IndicadorOperacionNueva" character varying(1) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT pk_operacionescredito PRIMARY KEY ("Id_Cliente", id_load,session_id,"IdOperacionCredito")
)
