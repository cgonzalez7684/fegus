...
public sealed class DataSetNameIngestion
{
    ...
    public static readonly DataSetNameIngestion CuentasXCobrar = new("CuentasXCobrar");
    public static readonly DataSetNameIngestion CuotasAtrasadas = new("CuotasAtrasadas");
    public static readonly DataSetNameIngestion FeBoxDataLoad = new("FeBoxDataLoad");
