...
public sealed class SendGarantiasOperacionUseCase
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            _logger.Info($"SendGarantiasOperacion using sessionId={session.SessionId} state={session.SessionStateCode} for idLoad={box.IdLoad} for idLoadLocal={box.IdLoadLocal} lastSequence={lastSequence}.");
