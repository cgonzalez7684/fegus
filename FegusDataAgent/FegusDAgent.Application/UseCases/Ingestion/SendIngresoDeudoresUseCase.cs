...
public sealed class SendIngresoDeudoresUseCase
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            _logger.Info($"SendIngresoDeudores using sessionId={session.SessionId} state={session.SessionStateCode} for idLoad={box.IdLoad} for idLoadLocal={box.IdLoadLocal} lastSequence={lastSequence}.");
