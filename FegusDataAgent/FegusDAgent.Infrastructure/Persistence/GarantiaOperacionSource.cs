...
public sealed class GarantiaOperacionSource : IEntitySource<GarantiaOperacion>
{
    ...
    public async IAsyncEnumerable<GarantiaOperacion> GetDataStreamAsync(
        int? idCliente,
        long? idLoadLocal,
    ...
    private async IAsyncEnumerable<GarantiaOperacion> ReadFromDatabaseAsync(
        int? idCliente,
        long? idLoadLocal,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT *
            FROM feguslocal.obtener_garantiasoperacion_lista(@id_load_local)
            """;
