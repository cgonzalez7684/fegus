...
public sealed class BienesRealizablesNoReportadosSource : IEntitySource<BienesRealizablesNoReportados>
{
    ...
    public async IAsyncEnumerable<BienesRealizablesNoReportados> GetDataStreamAsync(
        int? idCliente,
        long? idLoadLocal,
    ...
    private async IAsyncEnumerable<BienesRealizablesNoReportados> ReadFromDatabaseAsync(
        int? idCliente,
        long? idLoadLocal,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT *
            FROM feguslocal.obtener_bienesrealizablesnoreportados_lista(@id_load_local)
            """;
