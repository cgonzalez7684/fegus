...
public sealed class CodeudorSource : IEntitySource<Codeudor>
{
    private readonly IDbConnectionFactory _dbConnectionFactory;
    private readonly IEventLogger<CodeudorSource> _logger;

    public CodeudorSource(
        IDbConnectionFactory dbConnectionFactory,
        IEventLogger<CodeudorSource> logger)
    {
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        while (true)
        {
            ...
            {
                _logger.Error($"Failed to stream Codeudores for idLoadLocal={idLoadLocal}.", ex);
                throw;
            }
    ...
    private static Codeudor MapRow(NpgsqlDataReader reader) =>
        Codeudor.Create(
            ...
            idCodeudor:          GetString(reader, "idcodeudor"),
            tipoPersonaCodeudor: GetString(reader, "tipopersonacodeudor"));
