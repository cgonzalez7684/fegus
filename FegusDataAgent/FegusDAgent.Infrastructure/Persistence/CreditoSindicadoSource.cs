...
public sealed class CreditoSindicadoSource : IEntitySource<CreditoSindicado>
{
    ...
    public async IAsyncEnumerable<CreditoSindicado> GetDataStreamAsync(
        int? idCliente,
        long? idLoadLocal,
    ...
    private async IAsyncEnumerable<CreditoSindicado> ReadFromDatabaseAsync(
        int? idCliente,
        long? idLoadLocal,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT *
            FROM feguslocal.obtener_creditossindicados_lista(@id_load_local)
            """;
