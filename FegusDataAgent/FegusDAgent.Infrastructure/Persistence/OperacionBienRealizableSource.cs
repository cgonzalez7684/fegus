...
public sealed class OperacionBienRealizableSource : IEntitySource<OperacionBienRealizable>
{
    ...
    public async IAsyncEnumerable<OperacionBienRealizable> GetDataStreamAsync(
        int? idCliente,
        long? idLoadLocal,
    ...
    private async IAsyncEnumerable<OperacionBienRealizable> ReadFromDatabaseAsync(
        int? idCliente,
        long? idLoadLocal,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT *
            FROM feguslocal.obtener_operacionesbienesrealizables_lista(@id_load_local)
            """;
