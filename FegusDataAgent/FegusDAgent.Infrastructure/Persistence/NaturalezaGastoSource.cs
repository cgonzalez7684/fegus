...
public sealed class NaturalezaGastoSource : IEntitySource<NaturalezaGasto>
{
    ...
    public async IAsyncEnumerable<NaturalezaGasto> GetDataStreamAsync(
        int? idCliente,
        long? idLoadLocal,
    ...
    private async IAsyncEnumerable<NaturalezaGasto> ReadFromDatabaseAsync(
        int? idCliente,
        long? idLoadLocal,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT *
            FROM feguslocal.obtener_naturalezagasto_lista(@id_load_local)
            """;
