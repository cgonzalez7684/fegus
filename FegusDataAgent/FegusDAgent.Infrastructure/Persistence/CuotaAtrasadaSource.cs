...
public sealed class CuotaAtrasadaSource : IEntitySource<CuotaAtrasada>
{
    ...
    public async IAsyncEnumerable<CuotaAtrasada> GetDataStreamAsync(
        int? idCliente,
        long? idLoadLocal,
    ...
    private async IAsyncEnumerable<CuotaAtrasada> ReadFromDatabaseAsync(
        int? idCliente,
        long? idLoadLocal,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT *
            FROM feguslocal.obtener_cuotasatrasadas_lista(@id_load_local)
            """;
