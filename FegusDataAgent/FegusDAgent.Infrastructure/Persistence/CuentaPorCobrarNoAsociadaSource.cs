...
public sealed class CuentaPorCobrarNoAsociadaSource : IEntitySource<CuentaPorCobrarNoAsociada>
{
    ...
    public async IAsyncEnumerable<CuentaPorCobrarNoAsociada> GetDataStreamAsync(
        int? idCliente,
        long? idLoadLocal,
    ...
    private async IAsyncEnumerable<CuentaPorCobrarNoAsociada> ReadFromDatabaseAsync(
        int? idCliente,
        long? idLoadLocal,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT *
            FROM feguslocal.obtener_cuentasporcobrarnosasociadas_lista(@id_load_local)
            """;
