...
public sealed class ActividadEconomicaSource : IEntitySource<ActividadEconomica>
{
    ...
    public async IAsyncEnumerable<ActividadEconomica> GetDataStreamAsync(
        int? idCliente,
        long? idLoadLocal,
    ...
    private async IAsyncEnumerable<ActividadEconomica> ReadFromDatabaseAsync(
        int? idCliente,
        long? idLoadLocal,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT *
            FROM feguslocal.obtener_actividadeconomica_lista(@id_load_local)
            """;
