...
public sealed class OperacionNoReportadaSource : IEntitySource<OperacionNoReportada>
{
    ...
    public async IAsyncEnumerable<OperacionNoReportada> GetDataStreamAsync(
        int? idCliente,
        long? idLoadLocal,
    ...
    private async IAsyncEnumerable<OperacionNoReportada> ReadFromDatabaseAsync(
        int? idCliente,
        long? idLoadLocal,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT *
            FROM feguslocal.obtener_operacionesnoreportadas_lista(@id_load_local)
            """;
