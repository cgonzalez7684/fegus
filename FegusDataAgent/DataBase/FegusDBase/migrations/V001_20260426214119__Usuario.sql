-- Table: feguslocal.bienesrealizablesnoreportados3

-- DROP TABLE IF EXISTS feguslocal.bienesrealizablesnoreportados3;

CREATE TABLE IF NOT EXISTS feguslocal.bienesrealizablesnoreportados3
(
    ...
    CONSTRAINT pk_bienesrealizablesnoreportados3 PRIMARY KEY (id_load_local, idbienrealizable)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS feguslocal.bienesrealizablesnoreportados3
    OWNER to postgres;