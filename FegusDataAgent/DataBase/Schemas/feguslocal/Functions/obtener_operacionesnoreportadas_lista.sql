-- FUNCTION: feguslocal.obtener_operacionesnoreportadas_lista(bigint, bigint)

-- DROP FUNCTION IF EXISTS feguslocal.obtener_operacionesnoreportadas_lista(bigint, bigint);
...
ALTER FUNCTION feguslocal.obtener_operacionesnoreportadas_lista(bigint, bigint)
    OWNER TO postgres;
