-- FUNCTION: feguslocal.obtener_gravamenes_lista(bigint, bigint)

-- DROP FUNCTION IF EXISTS feguslocal.obtener_gravamenes_lista(bigint, bigint);
...
ALTER FUNCTION feguslocal.obtener_gravamenes_lista(bigint, bigint)
    OWNER TO postgres;
