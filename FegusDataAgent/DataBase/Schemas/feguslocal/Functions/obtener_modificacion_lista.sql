-- FUNCTION: feguslocal.obtener_modificacion_lista(bigint, bigint)

-- DROP FUNCTION IF EXISTS feguslocal.obtener_modificacion_lista(bigint, bigint);
...
ALTER FUNCTION feguslocal.obtener_modificacion_lista(bigint, bigint)
    OWNER TO postgres;
