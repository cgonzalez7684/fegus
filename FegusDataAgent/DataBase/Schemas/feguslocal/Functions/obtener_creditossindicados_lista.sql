-- FUNCTION: feguslocal.obtener_creditossindicados_lista(bigint, bigint)

-- DROP FUNCTION IF EXISTS feguslocal.obtener_creditossindicados_lista(bigint, bigint);
...
ALTER FUNCTION feguslocal.obtener_creditossindicados_lista(bigint, bigint)
    OWNER TO postgres;
