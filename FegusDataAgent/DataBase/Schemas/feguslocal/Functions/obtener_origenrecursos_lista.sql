-- FUNCTION: feguslocal.obtener_origenrecursos_lista(bigint, bigint)

-- DROP FUNCTION IF EXISTS feguslocal.obtener_origenrecursos_lista(bigint, bigint);
...
ALTER FUNCTION feguslocal.obtener_origenrecursos_lista(bigint, bigint)
    OWNER TO postgres;
