-- FUNCTION: feguslocal.obtener_garantiaspolizas_lista(integer, bigint)

-- DROP FUNCTION IF EXISTS feguslocal.obtener_garantiaspolizas_lista(integer, bigint);
...
ALTER FUNCTION feguslocal.obtener_garantiaspolizas_lista(bigint)
    OWNER TO postgres;
