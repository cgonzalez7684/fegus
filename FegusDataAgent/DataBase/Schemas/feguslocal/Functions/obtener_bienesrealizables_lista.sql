-- FUNCTION: feguslocal.obtener_bienesrealizables_lista(bigint, bigint)

-- DROP FUNCTION IF EXISTS feguslocal.obtener_bienesrealizables_lista(bigint, bigint);
...
ALTER FUNCTION feguslocal.obtener_bienesrealizables_lista(bigint, bigint)
    OWNER TO postgres;
