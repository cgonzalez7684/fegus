-- FUNCTION: feguslocal.obtener_cuentasporcobrarnosasociadas_lista(bigint, bigint)

-- DROP FUNCTION IF EXISTS feguslocal.obtener_cuentasporcobrarnosasociadas_lista(bigint, bigint);
...
ALTER FUNCTION feguslocal.obtener_cuentasporcobrarnosasociadas_lista(bigint, bigint)
    OWNER TO postgres;
