-- FUNCTION: feguslocal.obtener_cuotasatrasadas_lista(bigint, bigint)

-- DROP FUNCTION IF EXISTS feguslocal.obtener_cuotasatrasadas_lista(bigint, bigint);
...
ALTER FUNCTION feguslocal.obtener_cuotasatrasadas_lista(bigint, bigint)
    OWNER TO postgres;
