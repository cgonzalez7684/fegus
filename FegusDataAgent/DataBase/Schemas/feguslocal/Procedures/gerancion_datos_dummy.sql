...
BEGIN
    ...
    FOR i IN 1..p_num_registros LOOP
		...
		VALUES (
		    ...
		    -- TipoDeudorSFN (más frecuente 1 y 4)
		    CASE 
		    ...
		    -- TipoPersonaDeudor (personas físicas más comunes)
		    CASE 
		    ...
		    -- Sector económico (distribución más realista)
		    CASE 
		    ...
		    -- Capacidad de pago (más en niveles medios)
		    CASE 
		    ...
		    -- 🔥 MUY IMPORTANTE: Alta probabilidad de NULL
		    CASE 
